...
const contactInfo = [
  { icon: "📍", text: "Nairobi, KE" },
  { icon: "📧", text: "michaeldmwai@gmail.com" },
  {
    icon: <LinkedInIcon />,
    link: "https://www.linkedin.com/in/michael-mwai-6b351216a/",
  },
  { icon: <GitHubIcon />, link: "https://github.com/MichaelMwai" },
];
